...
function showDedicationText() { 
  ...
  if (!text) {
    text = `Para el amor de mi vida.⋆♡:\n\nDesde el primer momento supe que eras tú. Hay algo en tu mirada que me da paz, en tu risa que ilumina mis días y en tu forma de querer que me hace sentir segura.\n\nGracias por estar para mi, por escucharme incluso cuando no sé cómo explicarme, por abrazarme con palabras y con silencios ademas de llenar todos mis dias de amor:)).\n\nTe amo más de lo que las palabras pueden expresar pero que se siente en cada latido💗.\n\nTe dedico la cancion FIJATE FIJATE EN LA LETRA JSKAJS`;  } else {
  ...
  function type() {
    if (i <= text.length) {
      ...
      // Al terminar el typing, mostrar la firma
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Cami🖤🪐";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-06-29T00:00:00'); 
